    ...
    (a.jPlayer.prototype = {
      ...
      _init: function() {
        ...
        if (
          ...
          a.each(this.options.supplied.toLowerCase().split(","), function(
            b,
            d
          ) {
          ...
          a.each(this.options.solution.toLowerCase().split(","), function(
            b,
            d
          ) {
            var e = d.replace(/^\s+|\s+$/g, "");
          ...
          a.each(this.options.auroraFormats.toLowerCase().split(","), function(
            b,
            d
          ) {
            var e = d.replace(/^\s+|\s+$/g, "");
      ...
      _setOption: function(b, c) {
        ...
        switch (b) {
          ...
          case "cssSelector":
            ...
            break;
          case "playbackRate":
            (this.options[b] = c = this._limitValue(
              c,
              this.options.minPlaybackRate,
